...
static const int TICKS_PER_FRAME = 12;
static const int DISP_SCALE = 6;

int main (void) {
  // Initalizing rendering context
  sfVideoMode mode = {150*DISP_SCALE, 150*DISP_SCALE, 32};
  ...
  while (sfRenderWindow_isOpen(window)){
    ...
    handleMouseInput(window, cloth, DISP_SCALE);
